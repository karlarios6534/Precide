            ...
            <div class="content" style="margin-left: 25%; margin-right: 25%">
                <form action="/patients" method="POST">
                    ...
                    <div class = "mb-3">
                        ...
                        <input id="name" name="name" pattern="^[A-Za-zñÑ\s]{1,190}$" class="form-control bg-light rounded" tabindex="2" type="text" required>
                    </div>
                    <div class = "mb-3">
                    ...
                    <div class = "mb-3">
                        ...
                        <input id="allergies" name="allergies" pattern="^[A-Za-zñÑ\s.,]{1,190}$" class="form-control bg-light rounded"" tabindex="3" type="text" required>
                    </div>
